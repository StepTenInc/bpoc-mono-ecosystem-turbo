...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: 'BPO Salary & Compensation Guide Philippines | BPOC.IO',
    description: 'Comprehensive guides on BPO salaries, pay scales, and compensation packages in the Philippines. Learn about salary negotiations and benefits.',
    openGraph: {
      title: 'BPO Salary & Compensation | BPOC.IO',
      description: 'Complete salary guides and compensation insights for Philippine BPO workers.',
