...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: 'BPO Training & Certifications Philippines | BPOC.IO',
    description: 'Discover training programs and certifications to boost your BPO career. Professional development resources and skill building guides.',
    openGraph: {
      title: 'BPO Training & Certifications | BPOC.IO',
      description: 'Professional development and certification guides for Philippine BPO workers.',
...
async function getSiloData() {
  const { data: silo } = await supabase
    .from('insights_silos')
    .select('*')
    .eq('slug', 'training-and-certifications')
    .eq('is_active', true)
    .single();
