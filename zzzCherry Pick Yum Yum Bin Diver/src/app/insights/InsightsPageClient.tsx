...
export default function InsightsPageClient({ initialPosts, silos = [] }: InsightsPageClientProps) {
  ...
  return (
    <div className="min-h-screen bg-[#050506] text-white overflow-x-hidden">
      ...
      {/* HERO SECTION */}
      <section className="relative z-10 pt-24 md:pt-32 pb-12 md:pb-20 px-4 sm:px-6 md:px-12 lg:px-20">
        <div className="max-w-6xl mx-auto text-center">
          ...
          >
            <Badge className="mb-6 md:mb-8 bg-white/5 text-cyan-400 border-white/10 text-xs sm:text-sm px-4 py-2 backdrop-blur-sm">
              <Sparkles className="w-3 h-3 sm:w-4 sm:h-4 mr-2 text-yellow-400" />
              BPOC Research & Insights
            </Badge>

            <h1 className="text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-black tracking-tight mb-6 md:mb-8 leading-[0.95]">
            ...
            <p className="text-lg md:text-xl lg:text-2xl text-gray-400 max-w-3xl mx-auto leading-relaxed px-2">
      ...
      {silos.length > 0 && (
        <section className="relative z-10 py-12 md:py-20 px-4 sm:px-6 md:px-12 lg:px-20 border-t border-white/5">
          <div className="max-w-7xl mx-auto">
            ...
            >
              <div className="flex items-center gap-3 md:gap-4 mb-4">
                <div className="w-8 md:w-12 h-[2px] bg-gradient-to-r from-cyan-400 to-purple-400" />
                <span className="text-cyan-400 font-mono text-xs sm:text-sm uppercase tracking-widest">Browse by Topic</span>
              </div>
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white">
                Explore Categories
              </h2>
              <p className="text-gray-500 mt-2 md:mt-3 text-base md:text-lg">Deep-dive into specialized topics that matter to your career</p>
            </motion.div>
      ...
      <section className="relative z-10 py-12 md:py-20 px-4 sm:px-6 md:px-12 lg:px-20 bg-[#050506]">
        <div className="max-w-7xl mx-auto">
          {/* Section Header */}
          <motion.div
            initial={{ opacity: 0, y: 20 }}
          ...
          >
            <div className="flex items-center gap-3 md:gap-4 mb-4">
              <div className="w-8 md:w-12 h-[2px] bg-gradient-to-r from-purple-400 to-pink-400" />
              <span className="text-purple-400 font-mono text-xs sm:text-sm uppercase tracking-widest">Latest Content</span>
            </div>
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white">
              All Articles
            </h2>
            <p className="text-gray-500 mt-2 md:mt-3 text-base md:text-lg">{initialPosts.length} insights to level up your BPO career</p>
          </motion.div>
          ...
          {silos.length > 0 && (
            <motion.div
              ...
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              className="flex flex-wrap gap-2 sm:gap-3 mb-8 md:mb-12 overflow-x-auto pb-2 -mx-1 px-1"
            >
              <button
      ...
      {/* NEWSLETTER SECTION */}
      <section className="relative z-10 py-16 md:py-24 px-4 sm:px-6 md:px-12 lg:px-20">
        <div className="max-w-4xl mx-auto">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="relative overflow-hidden rounded-2xl md:rounded-3xl border border-white/10 p-6 sm:p-8 md:p-12 lg:p-16 text-center"
            style={{
          ...
          >
            ...
            <p className="text-base md:text-lg lg:text-xl text-gray-400 mb-6 md:mb-10 max-w-2xl mx-auto">
