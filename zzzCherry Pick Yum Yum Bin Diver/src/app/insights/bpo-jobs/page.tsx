...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: 'BPO Jobs & Opportunities | Find Your Next Role | BPOC.IO',
    description: 'Discover the latest BPO job opportunities in the Philippines. Expert guides on finding, landing, and thriving in outsourcing careers.',
    openGraph: {
      title: 'BPO Jobs & Opportunities | BPOC.IO',
      description: 'Expert guides on finding and landing BPO jobs in the Philippines.',
...
export default async function BpoJobsPage() {
