      ...
      <div className="relative z-10 container mx-auto px-4 py-20">
        ...
        >
          ...
          <div className="bg-pink-500/10 border border-pink-500/30 rounded-full px-6 py-2 backdrop-blur-sm relative group">
            ...
            <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none">
              <div className="bg-gray-900 border border-pink-500/50 rounded-lg p-3 text-xs text-sm md:text-base shadow-2xl">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
          ...
          <motion.div
            ...
            whileHover={{ y: -4 }}
            className="relative group bg-gradient-to-br from-gray-900/90 to-black rounded-2xl md:rounded-3xl p-5 md:p-10 border-2 border-gray-800/50 hover:border-purple-500/70 transition-all duration-500 shadow-[0_20px_70px_-15px_rgba(0,0,0,0.8)] hover:shadow-[0_30px_90px_-15px_rgba(168,85,247,0.4)]"
          >
            ...
            <div className="absolute top-4 right-4 bg-purple-500/20 border border-purple-500/30 rounded-full px-4 py-1 text-xs font-bold text-purple-300 relative group/progress">
              ...
              <div className="absolute top-full right-0 mt-2 opacity-0 group-hover/progress:opacity-100 transition-opacity pointer-events-none">
                <div className="bg-gray-900 border border-purple-500/50 rounded-lg p-3 text-xs text-sm md:text-base shadow-2xl">
          ...
          <motion.div
            ...
            whileHover={{ y: -4 }}
            className="relative group bg-gradient-to-br from-gray-900/90 to-black rounded-2xl md:rounded-3xl p-5 md:p-10 border-2 border-gray-800/50 hover:border-pink-500/70 transition-all duration-500 shadow-[0_20px_70px_-15px_rgba(0,0,0,0.8)] hover:shadow-[0_30px_90px_-15px_rgba(236,72,153,0.4)]"
          >
            {/* Gradient glow background */}
                ...
                {isFormValid && (
                  ...
                  >
                    ...
                    <div className="absolute bottom-full right-0 mb-2 opacity-0 group-hover/score:opacity-100 transition-opacity pointer-events-none">
                      <div className="bg-gray-900 border border-green-500/50 rounded-lg p-3 text-xs text-sm md:text-base shadow-2xl">
        ...
        {copied && (
          ...
          >
            ...
            <div className="absolute top-full right-0 mt-2 opacity-0 group-hover/achievement:opacity-100 transition-opacity pointer-events-none">
              <div className="bg-gray-900 border border-yellow-500/50 rounded-lg p-3 text-xs text-sm md:text-base shadow-2xl">
