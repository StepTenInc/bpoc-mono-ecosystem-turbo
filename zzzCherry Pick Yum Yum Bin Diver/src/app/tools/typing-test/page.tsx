    ...
    <>
      ...
      <div className="relative z-10 container mx-auto px-4 py-20">
        ...
        {started && !finished && (
          ...
          >
            ...
            <motion.div
              ...
              className="relative group bg-gradient-to-br from-gray-900/90 to-black rounded-2xl md:rounded-3xl p-5 md:p-10 border-2 border-gray-800/50 hover:border-yellow-500/70 transition-all duration-500"
            >
        ...
        {finished && (
          ...
          >
            <div className="relative bg-gradient-to-br from-gray-900/90 to-black rounded-2xl md:rounded-3xl p-5 md:p-12 border-2 border-yellow-500/70 shadow-[0_30px_90px_-15px_rgba(251,191,36,0.6)]">
