      ...
      <div className="relative z-10 container mx-auto px-4 py-20">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
          ...
          <motion.div
            ...
            whileHover={{ y: -4 }}
            className="relative group bg-gradient-to-br from-gray-900/90 to-black rounded-2xl md:rounded-3xl p-5 md:p-10 border-2 border-gray-800/50 hover:border-red-500/70 transition-all duration-500 shadow-[0_20px_70px_-15px_rgba(0,0,0,0.8)] hover:shadow-[0_30px_90px_-15px_rgba(239,68,68,0.4)]"
          >
          ...
          {showResults && jobData ? (
            <motion.div
              ...
              transition={{ duration: 0.6 }}
              whileHover={{ y: -4 }}
              className="relative group bg-gradient-to-br from-gray-900/90 to-black rounded-2xl md:rounded-3xl p-5 md:p-10 border-2 border-red-500/70 shadow-[0_30px_90px_-15px_rgba(239,68,68,0.5)]"
            >
              {/* Gradient glow background */}
            ...
            <motion.div
              ...
              animate={{ opacity: 1, x: 0 }}
              transition={{ duration: 0.6, delay: 0.3 }}
              className="bg-gradient-to-br from-gray-900/90 to-black rounded-2xl md:rounded-3xl p-5 md:p-10 border-2 border-gray-800/50 flex items-center justify-center"
            >
        ...
        <AnimatePresence>
          {showResults && jobData && missingRequired.length > 0 && (
            <motion.div
              ...
              className="mt-8 max-w-6xl mx-auto relative group bg-gradient-to-br from-gray-900/90 to-black rounded-2xl md:rounded-3xl p-5 md:p-10 border-2 border-purple-500/50 hover:border-purple-500/70 transition-all duration-500 shadow-[0_20px_70px_-15px_rgba(168,85,247,0.3)]"
            >
              {/* Gradient glow background */}
