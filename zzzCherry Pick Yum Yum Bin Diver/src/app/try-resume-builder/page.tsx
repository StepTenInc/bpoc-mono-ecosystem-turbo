                ...
                {result && (
                  ...
                  >
                    ...
                    <motion.div
                      ...
                      className="mb-12"
                    >
                      <div className="relative bg-gradient-to-br from-gray-900/90 to-black border-2 border-cyan-500/30 rounded-2xl md:rounded-3xl p-5 md:p-10 overflow-hidden">
                        {/* Glow effect */}
                    ...
                    >
                      ...
                      <div className="relative">
                        ...
                        <div className="relative bg-gradient-to-br from-cyan-500/5 via-purple-500/5 to-pink-500/5 border-2 border-cyan-500/30 rounded-2xl md:rounded-3xl p-5 md:p-10 backdrop-blur-sm">
                          ...
                          >
                            <div className="text-center">
                              <div className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black text-cyan-400 mb-2">
                            ...
                            <div className="text-center">
                              <div className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black text-green-400 mb-2">
                                {platformStats.avgDaysToInterview} days
                              </div>
                              <div className="text-gray-400 text-sm">average time to first interview</div>
                            </div>
                            <div className="text-center">
                              <div className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black text-purple-400 mb-2">
