...
Tone: Ate Yna voice (warm, professional, encouraging, uses "kaya mo yan!")
...
Return: Full HTML article with proper heading tags, links, and formatting`,
  ...
  stage5_humanize: `Rewrite this AI-generated content to pass AI detectors while maintaining the Ate Yna voice.
...
- Keep Ate Yna personality phrases
