...
export function calculateProfileCompletion(
  ...
  const fields = [
    ...
    { key: 'avatar_url', source: candidate, points: 10, label: 'Profile Photo' },
  ...
  if (percentage === 0) {
    ...
    encouragingMessage = `Great start! You're ${100 - percentage}% away from standing out!`
    nextStep = "Add a profile photo to make a great first impression"
  } else if (percentage < 50) {
    encouragingMessage = `Awesome progress! You're ${100 - percentage}% away from unlocking top matches!`
    ...
    encouragingMessage = "🎉 Perfect! Your profile is complete!"
