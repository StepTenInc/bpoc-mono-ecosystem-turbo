...
export async function POST(request: NextRequest) {
    try {
        ...
        const onboardingId = body.onboarding_id || body.onboardingId;
        const firstName = body.first_name || body.firstName;
        const middleName = body.middle_name || body.middleName;
        const lastName = body.last_name || body.lastName;
        const gender = body.gender;
        const civilStatus = body.civil_status || body.civilStatus;
        const dateOfBirth = body.date_of_birth || body.dateOfBirth;
        const contactNo = body.contact_no || body.contactNo;
