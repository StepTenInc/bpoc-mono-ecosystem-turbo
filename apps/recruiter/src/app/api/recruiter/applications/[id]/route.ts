...
export async function GET(
  ...
  try {
    ...
    if (!recruiter) {
      console.warn('[recruiter/applications/:id] Recruiter not found for user', { userId, application_id: id });
    ...
    if (checkError || !applicationCheck) {
      console.warn('[recruiter/applications/:id] Application does not exist', { userId, application_id: id });
