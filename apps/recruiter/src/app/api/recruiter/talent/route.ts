  ...
  try {
    ...
    let formattedCandidates = candidates.map((c: any) => {
      ...
      return {
        ...
        has_resume: c.has_resume || false,
        has_ai_analysis: c.has_ai_analysis || false,
        ai_score: c.ai_analysis?.overallScore || null,
        match_score: c.ai_analysis?.overallScore || null,
