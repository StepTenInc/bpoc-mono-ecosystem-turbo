  ...
  try {
        ...
        if (!viewError && candidateTruth) {
          ...
          return withCors(NextResponse.json({
            candidate: {
              ...
              first_name: candidateTruth.first_name,
              last_name: candidateTruth.last_name,
              fullName: candidateTruth.full_name,
              avatar_url: candidateTruth.avatar_url,
              username: candidateTruth.username,
              slug: candidateTruth.slug,
              is_active: candidateTruth.is_active,
              created_at: candidateTruth.candidate_created_at,
              updated_at: candidateTruth.candidate_updated_at,
              ...
              experience_years: candidateTruth.experience_years,
    ...
    const response = {
      candidate: {
        ...
        // Professional Info
        experience_years: Math.round(experienceYears * 10) / 10, // Round to 1 decimal
        ...
        resume: resumes && resumes.length > 0 ? {
          ...
          is_primary: resumes[0].is_primary,
        ...
        aiAnalysis: aiAnalyses && aiAnalyses.length > 0 ? {
          ...
          created_at: aiAnalyses[0].created_at,
        } : null,
